package com.gft.desafio.veterinario.config;

import com.gft.desafio.veterinario.entities.*;
import com.gft.desafio.veterinario.repositories.*;
...
public class PopularBanco implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Usuario u1 = new Usuario(null, "veterinario@gft.com", new BCryptPasswordEncoder().encode("1234"), p1);
        Usuario u2 = new Usuario(null, "cliente@gft.com", new BCryptPasswordEncoder().encode("1234"), p2);
        ...
        Cliente clienteA = new Cliente(null, "Luiz Felipe", "luizfelipe@gft.com", "(81) 999999999", enderecoA, "11111111111", null);
        Cliente clienteB = new Cliente(null, "Luiz", "luiz@gft.com", "(81) 999999999", enderecoB, "22222222222", null);
        ...
        Veterinario veterinario = new Veterinario(null, "Guilherme", "guilherme@gft.com", "(81) 999999999", enderecoC, "11111111111");
